    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#">教师风采 <span class="sr-only">(current)</span></a></li>
                <li><a href="#">优秀学员</a></li>
                <li class="dropdown">
...
<div class="container-fluid" >
    <div class="row">
        <div class="col-md-3" style="background: chartreuse"> 23123</div>
        <div class="col-md-9" style="background: azure"> 123123</div>
    </div>
</div>
