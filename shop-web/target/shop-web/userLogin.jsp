...
<div class="container-fluid" >
    ...
    <div class="row">
        ...
        <div class="col-sm-8" id="bodyDiv" style="float: left;width: 100%">
            ...
            <form   onsubmit="addMD5()" class="form-horizontal" role="form" action="<%=request.getContextPath()%>/user/userLogin.jhtml" method="post" enctype="multipart/form-data" >
                <fieldset>
                ...
                <div class="form-group" >
                    <div class="col-md-offset-3">
                        <button  class="btn btn-success  col-sm-1" type="submit">
