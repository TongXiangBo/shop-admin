...
<head>
  ...
  <%--  <link rel="stylesheet" href="<%=request.getContextPath()%>/bootstrap/css/font-awesome.min.css">--%>
    <link rel="stylesheet" type="text/css" href="/datatable/DataTables/css/dataTables.bootstrap.min.css">
...
<div class="container-fluid"  >
    <div class="row">
        <div id="listGroupDiv" class="col-sm-4" style="float: left;width: 1%">
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" >
                <div name="menuDiv" class="panel panel-default" style="margin:0;">

                    <div class="panel-heading" name="menuDiv">
                ...
                <div name="menuDiv" class="panel panel-default" style="margin:0;">
                    ...
                    <div name="menuDiv" class="panel-heading">
...
<script>
    $(function () {
       ...
       /* $("#accordion").attr("style","float:left;width:0px")
        $("div[name='menuDiv']").attr("style","float:left;width:0px")*/
    })
   ...
   /* $("#menu-toggle").click(function(e) {
    ...
    $("#menu-toggle").click(function(e) {
        if(v_booln){
        $("#listGroupDiv").css("display","")
            $("#listGroupDiv").attr("style","float:left;width:20%")
            $("#bodyDiv").attr("style","float:right;width:80%")
            v_booln=false;
        return false;
        }else {
            $("#listGroupDiv").hide()

            $("#bodyDiv").attr("style","float:left;width:100%")
            v_booln=true;
        }
